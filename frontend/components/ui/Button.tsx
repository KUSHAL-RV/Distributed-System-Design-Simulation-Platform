...
export function Button({
  ...
  const variants = {
    ...
    secondary:
      'bg-white/10 hover:bg-white/15 text-white border border-white/10 backdrop-blur-sm focus:ring-white/30',
    danger:
    ...
    ghost:
      'hover:bg-white/5 text-gray-400 hover:text-white focus:ring-white/20',
  };
